...
| [C2 · 락·동기화·병행성 버그](C2_락_동기화_그리고_버그.md) | 28–29·32 | 락·데이터 레이스·데드락 | `futex` 추적, `race.c` 실증 |
| [C3 · 조건변수·세마포어·이벤트기반](C3_조건변수_세마포어_이벤트기반.md) | 30·31·33 | 조건변수·세마포어·epoll | `futex`·`epoll_trace` |
